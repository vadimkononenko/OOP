...
void CubeShape::Show(HDC hdc)
{
	...
	LineShape::Set(x1 - cubeMerge *3, y1 - cubeMerge *3,
		x2 - cubeMerge *3, y2 - cubeMerge *3);
	LineShape::Show(hdc);

	LineShape::Set(x1 - cubeMerge*3, y1 + cubeMerge,
		x2 - cubeMerge*3, y2 + cubeMerge);
	LineShape::Show(hdc);
	...
	LineShape::Set(x1 + cubeMerge, y1 - cubeMerge*3,
		x2 + cubeMerge, y2 - cubeMerge*3);
	LineShape::Show(hdc);
