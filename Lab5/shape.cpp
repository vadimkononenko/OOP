...
void LineOOShape::Show(HDC hdc, int defPen)
{
	...
	__x2 = xs2;
	__y2 = ys2;
	LineShape::Set(__x1 - lineooMerge / 2, __y1 - lineooMerge / 2,
		__x2 - lineooMerge / 2, __y2 - lineooMerge / 2);
...
void CubeShape::Show(HDC hdc, int defPen)
{
	...
	LineShape::Set(__x1 - cubeMerge * 3, __y1 - cubeMerge * 3,
		__x2 - cubeMerge * 3, __y2 - cubeMerge * 3);
	LineShape::Show(hdc, defPen);

	LineShape::Set(__x1 - cubeMerge * 3, __y1 + cubeMerge,
		__x2 - cubeMerge * 3, __y2 + cubeMerge);
	LineShape::Show(hdc, defPen);
	...
	LineShape::Set(__x1 + cubeMerge, __y1 - cubeMerge * 3,
		__x2 + cubeMerge, __y2 - cubeMerge * 3);
	LineShape::Show(hdc, defPen);
